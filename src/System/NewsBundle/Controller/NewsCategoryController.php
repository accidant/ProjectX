...
class NewsCategoryController extends AbstractModuleController
{
    ...
    public function createAction()
    {
        ...
        if ($form->isValid()) {
            ...
            return array (
                'method' => 'redirect',
                'url'    => $this->generateUrl('newscategory_show', array('id' => $entity->getId(), 'status'=>true, 'message'=>'News Category created successfully')),
            );
        }
    ...
    public function deleteAction()
    {
        ...
        if ($form->isValid()) {*/
            ...
            if ($entityNews) {
                return array (
                    'method' => 'redirect',
                    'url'    => $this->generateUrl('newscategory_show', array('id'=>$id, 'status'=>false, 'message'=>'News Category deletion failed. At least one News exists for this Category.'))
                );
            }
